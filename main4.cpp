...
int main(){
	...
	for( i=0; i<n;i++){
		...
		cout<<endl;}
	cout<<endl;
	int **arr3=new int *[n];			//создаём 3 квадратную матрицу из наибольших элементов двух других
	for(i=0;i<n;i++)
	arr3[i]=new int [n];
	for(int i=0; i<n;i++){
		for( j=0;j<n;j++){
	...
	cout<<"Третья матрица: "<<endl;			//вводим 3 матрицу созданную из наибольших элементов двух других
	for( i=0; i<n;i++){
		for( j=0;j<n;j++){
			cout<<arr3[i][j]<<" ";}
		cout<<endl;}
